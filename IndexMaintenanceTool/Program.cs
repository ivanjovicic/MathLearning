...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        var connectionString = Environment.GetEnvironmentVariable("CONNECTION_STRING") 
            ?? "Host=ep-wispy-smoke-ag4qtxhe-pooler.c-2.eu-central-1.aws.neon.tech;Port=5432;Username=neondb_owner;Password=npg_WB4rnl2CQamX;Database=neondb;SSL Mode=Require;Trust Server Certificate=true;";
