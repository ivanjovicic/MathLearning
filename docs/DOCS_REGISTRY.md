...
|---|---|---|---|---|---|
| [`.ai/PROMPT_LINT_CHECKLIST.md`](../.ai/PROMPT_LINT_CHECKLIST.md) | prompt-policy | `backend-agent-system` | required | 2026-07-31 | Forward-only prompt contract and admission requirements. |
...
| [`.ai/VALIDATION_SELECTOR.md`](../.ai/VALIDATION_SELECTOR.md) | validation-policy | `backend-agent-system` | required | 2026-07-31 | Select the narrowest sufficient executable proof. |
...
| [`docs/BUGFIX_PATTERN_GUARDRAILS.md`](BUGFIX_PATTERN_GUARDRAILS.md) | engineering-guardrail | `backend-quality` | advisory | 2026-07-31 | Regression proof expectations by bug class. |
