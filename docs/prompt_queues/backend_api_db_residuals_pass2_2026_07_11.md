...
| `BACKEND-API-DB-015` | P0/P1 | Done 85% — current-main lease/owner-token implementation is delivered; old PRs #16/#17 superseded; residual PostgreSQL concurrency/takeover proof remains. Run log: `.ai/runs/2026-09-23-BACKEND-API-DB-015-evidence.md`; validation: focused 32/32 pass; commit: self | Prevent permanent pending economy/cosmetics idempotency tombstones and prove safe recovery. | Canonical extension of `BACKEND-TEST-014`, `BACKEND-TEST-032/033` |
