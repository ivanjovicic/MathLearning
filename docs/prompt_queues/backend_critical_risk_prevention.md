...
|---|---|---|---|
| BACKEND-CRIT-001 | Done (`67173f4`, 2026-06-24, validated) | — | Harden backend error responses so raw exception messages do not reach clients. Run log: `.ai/runs/2026-06-24-BACKEND-CRIT-001-evidence.md`. Tests: `GlobalExceptionMiddlewareTests`, `AuthSafeErrorResponseTests`. Risk: backend-error-leak on auth + global middleware. |
| BACKEND-CRIT-002 | Done (`67173f4`, 2026-06-24, validated) | — | Protect/redact monitoring/log endpoints. Run log: `.ai/runs/2026-06-24-BACKEND-CRIT-002-evidence.md`. Tests: `MonitoringLogAuthorizationTests`, `LogOutputRedactorTests`. Risk: monitoring-log-exposure. |
| BACKEND-CRIT-003 | Done (fa83250, 2026-07-01, validated) | BACKEND-CRIT-008 | Prevent public identity/progress overexposure on search/profile/leaderboard surfaces. Run log: `.ai/runs/2026-07-01-BACKEND-CRIT-003-evidence.md`. Tests: `PublicIdentitySurfaceTests`, `LeaderboardEndpointsIntegrationTests`, `MobileCompatibilityEndpointsIntegrationTests.UserProfileById_CompatibilityAlias_MatchesCanonicalRoute`. |
...
| BACKEND-CRIT-007 | Done (`86f4be5`, 2026-07-01) | — | Offline timestamp bounds and UTC normalization. Run log: `.ai/runs/2026-07-01-BACKEND-CRIT-007-evidence.md`. Tests: `OfflineAnswerTimestampPolicyTests`, `OfflineAnswerTimestampIntegrationTests`. Risk: offline-time-trust. |
