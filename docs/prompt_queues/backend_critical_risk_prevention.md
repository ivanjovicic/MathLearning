...
| BACKEND-CRIT-007 | Done (`f1188af`, 2026-07-01) | — | Offline timestamp bounds and UTC normalization. Run log: `.ai/runs/2026-07-01-BACKEND-CRIT-007-evidence.md`. Tests: `OfflineAnswerTimestampPolicyTests`, `OfflineAnswerTimestampIntegrationTests`. Risk: offline-time-trust. |
