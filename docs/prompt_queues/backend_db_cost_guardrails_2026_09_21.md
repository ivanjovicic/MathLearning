...
|---|---:|---|---|---|
| `BACKEND-OPS-FLY-AUTOSTOP-001` | P0 cost/reliability | Ready | [Open](backend_db_cost_guardrails_2026_09_21/BACKEND-OPS-FLY-AUTOSTOP-001.md) | Stop the idle Fly machine and auto-start it on demand before real production traffic. |
