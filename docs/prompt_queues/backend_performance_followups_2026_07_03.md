...
| BE-PERF-015 | P0/P1 | Done 85% — Run log: `.ai/runs/2026-07-31-BE-PERF-015-evidence.md`; Validation: PracticeSession Idempotency+Integration 10/10 on PostgreSQL; Residual risk: requires OutboxProcessor in deploy; push/PR/main open; Commit: self | Make practice answer/completion concurrency settle exactly once and replay deterministically. |
