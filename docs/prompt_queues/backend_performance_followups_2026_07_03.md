...
| BE-PERF-014 | P1 | Done 79% — Run log: `.ai/runs/2026-07-31-BE-PERF-014-evidence.md`; Validation: ExplanationCacheServiceTests 7/7; Residual risk: multi-replica stampede without Redis and PG upsert proof deferred; push/PR/main open; Commit: self | Prevent explanation-cache stampedes, write-on-read amplification and expired-row growth. |
