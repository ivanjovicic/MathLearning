...
| BACKEND-TEST-027 | Done 95% — PR #33 merged as `a6cf0430`; Agent System, build and schema-from-zero passed; no QuestionEndpoints/authoring failures in Database Validation; unrelated 12-test global baseline remains tracked separately. | Dead unwired `QuestionEndpoints` removed; absence/route regression coverage prevents reintroduction. |
