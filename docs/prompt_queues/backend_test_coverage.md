...
| BACKEND-TEST-027 | Done 100% — refreshed from current main on 2026-09-23; dead `QuestionEndpoints` removed and absence/authoring regression tests carried forward; CI pending on refresh PR | Remove dead unwired `QuestionEndpoints`; canonical authoring and learner delivery surfaces remain unchanged. |
