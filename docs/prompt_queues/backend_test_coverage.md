...
| BACKEND-TEST-027 | Needs validation — refreshed from current main on 2026-09-23; dead `QuestionEndpoints` removed and absence/authoring regression tests carried forward; fresh CI pending | Remove dead unwired `QuestionEndpoints`; canonical authoring and learner delivery surfaces remain unchanged. |
