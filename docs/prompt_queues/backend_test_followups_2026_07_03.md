...
| BACKEND-TEST-027 | P1/P2 | Needs validation — refreshed from current main 2026-09-23; dead endpoint family removed with absence/authoring regression coverage; fresh CI pending | Remove dead `QuestionEndpoints`; prevent route/limit drift. |
