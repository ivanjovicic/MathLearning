...
namespace MathLearning.Infrastructure.Migrations.Api
{
    ...
    [Migration("20260923145307_AddDesignTokenDraftUniqueness")]
    partial class AddDesignTokenDraftUniqueness
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MathLearning.Domain.Entities.CosmeticCatalogRevision", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("cosmetic_catalog_revisions", (string)null);
                });
            ...
            modelBuilder.Entity("MathLearning.Domain.Entities.CosmeticItem", b =>
                {
                    ...
                    b.Property<string>("FragmentLabel")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");

                    b.Property<int?>("FragmentsRequired")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MathLearning.Domain.Entities.CosmeticsIdempotencyLedger", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("cosmetics_idempotency_ledger", (string)null);
                });

            modelBuilder.Entity("MathLearning.Domain.Entities.DailyRunChestClaim", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("CosmeticFragment")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
                    ...
                    b.ToTable("daily_run_chest_claims", (string)null);
                });
            ...
            modelBuilder.Entity("MathLearning.Domain.Entities.EconomyRewardDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MathLearning.Domain.Entities.EconomyTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MathLearning.Domain.Entities.IdempotencyLedger", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "OperationType", "OperationId")
                        .IsUnique()
                        .HasDatabaseName("UX_idempotency_ledger_user_type_operation");

                    b.ToTable("idempotency_ledger", (string)null);
                });
            ...
            modelBuilder.Entity("MathLearning.Domain.Entities.QuizSession", b =>
                {
                    ...
                    b.Property<string>("IssuedQuestionIdsJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue("[]");
            ...
            modelBuilder.Entity("MathLearning.Domain.Entities.SyncDeadLetter", b =>
                {
                    ...
                    b.HasIndex("Status", "LastFailedAtUtc", "Id")
                        .HasDatabaseName("IX_SyncDeadLetter_Status_LastFailedAtUtc_Id");

                    b.HasIndex("UserId", "DeviceId", "OperationId")
                        .IsUnique()
            ...
            modelBuilder.Entity("MathLearning.Domain.Entities.SyncEventLog", b =>
                {
                    ...
                    b.HasIndex("Status", "ReceivedAtUtc", "Id")
            ...
            modelBuilder.Entity("MathLearning.Domain.Entities.UserAnswer", b =>
                {
                    ...
                    b.HasIndex("UserId", "DeviceId", "SyncOperationId")
                        .IsUnique()
            ...
            modelBuilder.Entity("MathLearning.Domain.Entities.UserAvatarConfig", b =>
                {
                    ...
                    b.ToTable("user_avatar", (string)null);
                });

            modelBuilder.Entity("MathLearning.Domain.Entities.UserCosmeticFragmentProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("user_cosmetic_fragment_progress", (string)null);
                });
            ...
            modelBuilder.Entity("MathLearning.Domain.Entities.UserCosmeticLoadoutProjection", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(450)
                        .HasColumnType("character varying(450)");

                    b.Property<int?>("AnswerEffectId")
                        .HasColumnType("integer");

                    b.Property<string>("AnswerEffectJson")
                        .HasColumnType("jsonb");

                    b.Property<int?>("AvatarFrameId")
                        .HasColumnType("integer");

                    b.Property<int?>("AvatarGearId")
                        .HasColumnType("integer");

                    b.Property<string>("AvatarGearJson")
                        .HasColumnType("jsonb");

                    b.Property<string>("FrameJson")
                        .HasColumnType("jsonb");

                    b.Property<long>("LoadoutVersion")
                        .HasColumnType("bigint");

                    b.Property<int?>("ProfileBackgroundId")
                        .HasColumnType("integer");

                    b.Property<string>("ProfileBackgroundJson")
                        .HasColumnType("jsonb");

                    b.Property<string>("RecentRareUnlocksJson")
                        .HasColumnType("jsonb");
                    ...
                    b.HasIndex("AvatarFrameId")
                        .HasDatabaseName("IX_user_cosmetic_loadouts_frame_id");

                    b.HasIndex("ProfileBackgroundId")
                        .HasDatabaseName("IX_user_cosmetic_loadouts_bg_id");

                    b.ToTable("user_cosmetic_loadout_projections", (string)null);
                });
            ...
            modelBuilder.Entity("MathLearning.Domain.Entities.UserSeasonDailyRunClaim", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("DailyRunClaimId")
                        .HasColumnType("uuid");

                    b.Property<string>("DailyRunTransactionId")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
                    ...
                    b.HasIndex("UserId", "DailyRunTransactionId")
                        .IsUnique()
                    ...
                    b.ToTable("user_season_daily_run_claims", (string)null);
                });

            modelBuilder.Entity("MathLearning.Domain.Entities.UserSeasonMilestoneClaim", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("FragmentCopiesAwarded")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserId", "SeasonId", "ClaimedAtUtc")
                        .HasDatabaseName("IX_user_season_milestone_claims_user_season_claimed_at");

                    b.HasIndex("UserId", "SeasonId", "MilestoneId")
                        .IsUnique()
                        .HasDatabaseName("UX_user_season_milestone_claims_user_season_milestone");

                    b.ToTable("user_season_milestone_claims", (string)null);
                });

            modelBuilder.Entity("MathLearning.Domain.Entities.UserSeasonProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("user_season_progress", (string)null);
                });
